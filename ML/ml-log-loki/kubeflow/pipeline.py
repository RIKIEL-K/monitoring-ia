...
def log_clustering_pipeline(
    ...
    train_task.set_env_variable(name="AWS_ENDPOINT_URL", value=minio_endpoint)
    ...
    register_task.set_env_variable(name="AWS_ENDPOINT_URL", value=minio_endpoint)
    ...
    validate_task.set_env_variable(name="AWS_ENDPOINT_URL", value=minio_endpoint)
    ...
    deploy_task.set_env_variable(name="AWS_ENDPOINT_URL", value=minio_endpoint)
