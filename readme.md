...
> [!NOTE]
> La documentation complète de toutes les erreurs rencontrées et de leurs solutions est disponible sur **MkDocs** dans la section **Troubleshooting**.
>
> Lancez le site de documentation avec :
> ```bash
> mkdocs serve
> ```
> Puis ouvrez **http://localhost:8000/troubleshooting/**
